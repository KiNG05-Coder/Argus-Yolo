...
class SettingsPage(QWidget):
    ...
    def _create_ai_settings(self) -> QGroupBox:
        ...
        self._auto_confirm_slider = QSlider(Qt.Orientation.Horizontal)
        self._auto_confirm_slider.setRange(0, 100)
        self._auto_confirm_label = QLabel("0.75")
        self._auto_confirm_slider.valueChanged.connect(
            lambda v: self._auto_confirm_label.setText(f"{v / 100:.2f}")
        )
        auto_confirm_layout = QHBoxLayout()
        auto_confirm_layout.addWidget(self._auto_confirm_slider)
        auto_confirm_layout.addWidget(self._auto_confirm_label)
        layout.addRow("Auto-Confirm Threshold:", auto_confirm_layout)
    ...
    def _load_defaults_from_config(self) -> None:
        ...
        self._auto_confirm_slider.setValue(int(config.ai.auto_confirm_threshold * 100))
    ...
    def _on_save(self) -> None:
        ...
        self._settings = {
            ...
            "ai.auto_confirm_threshold": self._auto_confirm_slider.value() / 100,
    ...
    def load_settings(self, settings: dict[str, Any]) -> None:
        ...
        if "ai.auto_confirm_threshold" in settings:
            self._auto_confirm_slider.setValue(
                int(settings["ai.auto_confirm_threshold"] * 100)
            )
